...
const extension = {
    ...
    autoStart: true,
    requires: [apputils_1.ICommandPalette, mainmenu_1.IMainMenu, notebook_1.INotebookTracker],
    activate: (app, palette, mainMenu, notebookTracker) => {
        console.log('✅ JupyterLab extension jupyterlab_comments is activated!');
        const createCommentsWidget = (cellId, username) => {
            const commentsWidget = new widgets_1.Widget();
      ...
      `;
            ...
            const commentInput = content.querySelector(`#comment-input-${cellId}`);
            ...
            const fetchComments = async () => {
                try {
                    ...
                    comments.forEach((comment) => {
                        ...
                        commentsList === null || commentsList === void 0 ? void 0 : commentsList.appendChild(li);
                    });
                }
                catch (err) {
            ...
            fetchComments();
            addButton === null || addButton === void 0 ? void 0 : addButton.addEventListener('click', async () => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.jp-CommentsWidget {
  background-color: #f9f9f9;
  border-left: 1px solid #ddd;
  overflow-y: auto;
}

.jp-CommentsWidget h2 {
  font-size: 1.2em;
  margin-bottom: 10px;
}

.jp-CommentsWidget input {
  padding: 5px;
  border: 1px solid #ccc;
  border-radius: 3px;
}

.jp-CommentsWidget button {
  padding: 5px 10px;
...
.jp-CommentsWidget button:hover {
  background-color: #005a9e;
}

.jp-CommentsWidget ul {
  list-style-type: none;
  padding: 0;
}

.jp-CommentsWidget li {
  padding: 5px 0;
  border-bottom: 1px solid #eee;
}`, "",{"version":3,"sources":["webpack://./style/index.css"],"names":[],"mappings":"AAAA;EACE,yBAAyB;EACzB,2BAA2B;EAC3B,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,sBAAsB;EACtB,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;EACjB,yBAAyB;EACzB,YAAY;EACZ,YAAY;EACZ,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,qBAAqB;EACrB,UAAU;AACZ;;AAEA;EACE,cAAc;EACd,6BAA6B;AAC/B","sourcesContent":[".jp-CommentsWidget {\n  background-color: #f9f9f9;\n  border-left: 1px solid #ddd;\n  overflow-y: auto;\n}\n\n.jp-CommentsWidget h2 {\n  font-size: 1.2em;\n  margin-bottom: 10px;\n}\n\n.jp-CommentsWidget input {\n  padding: 5px;\n  border: 1px solid #ccc;\n  border-radius: 3px;\n}\n\n.jp-CommentsWidget button {\n  padding: 5px 10px;\n  background-color: #0078d4;\n  color: white;\n  border: none;\n  border-radius: 3px;\n  cursor: pointer;\n}\n\n.jp-CommentsWidget button:hover {\n  background-color: #005a9e;\n}\n\n.jp-CommentsWidget ul {\n  list-style-type: none;\n  padding: 0;\n}\n\n.jp-CommentsWidget li {\n  padding: 5px 0;\n  border-bottom: 1px solid #eee;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=lib_index_js.8071ac5d1203643243e3.js.map