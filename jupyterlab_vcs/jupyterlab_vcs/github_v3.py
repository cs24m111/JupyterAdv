...
def create_pull_request(
    owner_login, repo_name, title, head, base, access_token, pranay_endpoint
):
    content = {}
    ...
    try:
        ...
        result = {
            ...
            "pranay_url": content["html_url"].replace(
                "https://github.com/", pranay_endpoint
            ),
        }
        return result
...
def get_repository_details_for_pr(
    owner_login, repo_name, access_token, new_branch_name
):
