...
import { CommitMessageDialog, CommitPushed } from './ui_elements';
import { createAndPushCommit, configureGit, resetConfigureGit } from './api_client';
export class vcsSidebar extends Widget {
    ...
    async _onCreateCommit() {
        ...
        await createAndPushCommit({ commit_message: commitMessage }, async (githubUrl, pranayUrl) => {
            if (githubUrl) {
